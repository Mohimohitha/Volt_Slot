...
export default function SignUp({ onNavigate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://volt-slot.onrender.com/api/auth/register', {
        method: 'POST',
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 min-h-full">
        ...
        <div className="relative hidden lg:flex lg:col-span-6 xl:col-span-7 flex-col justify-between p-12 overflow-hidden border-r border-slate-200 dark:border-[#152026]">
          <div 
            ...
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1593941707882-a5bba14938c7?auto=format&fit=crop&q=80&w=1600')`
            }}
          />
          ...
          <div className="relative z-10 max-w-xl my-auto py-12 text-white">
            <h1 className="text-4xl xl:text-5xl font-extrabold tracking-tight leading-[1.15] mb-6">
              Autonomous <br />
              <span>Grid Access</span> <br />
              Enrollment.
            </h1>
            <p className="text-slate-300 dark:text-[#8899a6] text-sm leading-relaxed mb-10 max-w-md">
              Create an account to unlock instant bay reservations, live battery telemetry, and intelligent charger routing across the region.
            </p>

            <div className="flex items-center gap-12 pt-4">
              <div>
                <span className="font-mono text-[10px] tracking-widest text-emerald-400 dark:text-[#00e676] uppercase block mb-1">Fast DC Ports</span>
                <span className="text-2xl font-bold tracking-tight">120 kW</span>
              </div>
              <div className="w-[1px] h-8 bg-white/20 dark:bg-[#1a262d]" />
              <div>
                <span className="font-mono text-[10px] tracking-widest text-emerald-400 dark:text-[#00e676] uppercase block mb-1">Allocation Time</span>
                <span className="text-2xl font-bold tracking-tight">&lt; 30s</span>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-6 xl:col-span-5 flex items-center justify-center p-6 sm:p-12">
          <div className="w-full max-w-[420px]">
            ...
            <div className="mb-6">
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900 dark:text-white mb-2">Register Member</h2>
              <p className="text-slate-500 dark:text-[#8899a6] text-xs leading-relaxed">
                Create your account to start discovering and booking EV charging slots.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="signup-name" className="font-mono text-[10px] tracking-widest text-slate-500 dark:text-[#8899a6] uppercase block mb-1.5">
                  Full Name
                </label>
                <input
                  id="signup-name"
                  ...
                  placeholder="Mohitha Bramhanapalli"
              ...
              <div>
                <label htmlFor="signup-email" className="font-mono text-[10px] tracking-widest text-slate-500 dark:text-[#8899a6] uppercase block mb-1.5">
                  Email
                </label>
                <input
                  id="signup-email"
              ...
              <div>
                <label htmlFor="signup-password" className="font-mono text-[10px] tracking-widest text-slate-500 dark:text-[#8899a6] uppercase block mb-1.5">
                  Password
                </label>
              ...
              <div>
                <label htmlFor="signup-confirm-password" className="font-mono text-[10px] tracking-widest text-slate-500 dark:text-[#8899a6] uppercase block mb-1.5">
                  Confirm Password
                </label>
                <div className="relative">
                  <input
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#00e5ff] hover:bg-[#00c8de] text-black font-bold text-xs py-3 mt-2 rounded-lg flex items-center justify-center gap-2 transition-all cursor-pointer shadow-[0_0_20px_rgba(0,229,255,0.25)] hover:shadow-[0_0_25px_rgba(0,229,255,0.4)] disabled:opacity-50"
              >
                {loading ? 'Registering...' : 'Complete Enrollment'} <ArrowRight size={15} />
              </button>
            </form>

            <div className="mt-6 text-center text-xs text-slate-500 dark:text-[#8899a6]">
              Already have an account?{' '}
              <button
                type="button"
                onClick={() => onNavigate('signin')}
                className="font-mono text-[#00e5ff] hover:underline ml-1 cursor-pointer font-semibold"
              >
                Login
              </button>
            </div>
